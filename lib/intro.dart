              ...
              child: TimelineComponent(
                timelineList: <TimelineModel>[
                  TimelineModel(
                    ...
                    group: "Иб-021",
                    lesson: LessonTypes(context).lessons[LessonIds.physicalCulture.index],
                  ...
                  TimelineModel(
                    ...
                    group: "Иб-021",
                    lesson: LessonTypes(context).lessons[LessonIds.ethics.index],
                  ...
                  TimelineModel(
                    ...
                    group: "Иб-021",
                    lesson: LessonTypes(context).lessons[LessonIds.economics.index],
                  ...
                  TimelineModel(
                    ...
                    group: "Иб-021",
                    lesson: LessonTypes(context).lessons[LessonIds.history.index],
                  ...
                  TimelineModel(
                    ...
                    group: "Иб-021",
                    lesson: LessonTypes(context).lessons[LessonIds.lifeSafety.index],
